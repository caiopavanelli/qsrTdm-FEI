...
dist(pk(BodyA , DepthA , SizeA , DistanceA ),pk( BodyB , DepthB , SizeB , DistanceB ), Distance, loc( Xr, Yr ), do(Action, Situation)):-	
	...
	location(Robot, loc(Xr, Yr), do(PreviousAction, Situation)),
	dist(pk(BodyA, DepthA, SizeA, DistanceA), pk(BodyB, DepthB, SizeB, DistanceB), Distance, loc(Xr, Yr), do(PreviousAction, Situation)),
	!.
...
%% one peak
dist(pk(BodyA , DepthA , SizeA , DistanceA ), Distance, loc( Xr, Yr ), do(Action, _Situation)):-
	Action=sense(Profile, loc(Xr, Yr), _Time),
	member(pk(BodyA, DepthA, SizeA, DistanceA), Profile),
	Distance is DistanceA,
	!.
...
dist(pk(BodyA , DepthA , SizeA , DistanceA ), Distance, loc( Xr, Yr ), do(Action, Situation)):-	
	...
	prevAction(PreviousAction, Action, ActionList),
	location(Robot, loc(Xr, Yr), do(PreviousAction, Situation)),
	dist(pk(BodyA, DepthA, SizeA, DistanceA), Distance, loc(Xr, Yr), do(PreviousAction, Situation)),
	!.
