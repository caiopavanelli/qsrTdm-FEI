...
shrinking(pk(Body, DepthA, SizeA, DistanceA), loc(Xr, Yr), do(Action, Situation)):-
...
shrinking(pk(Body, DepthA, SizeA, DistanceA), loc(Xa, Ya), do(Action, Situation)):-
...
shrinking(pk(Body, DepthA, SizeA, DistanceA), loc(Xr, Yr), do(Action, Situation)):-
	...
	shrinking(pk(Body, DepthA, SizeA, DistanceA), loc(Xr, Yr), do(PreviousAction, Situation)),
	!.
	
shrinking(pk(Body, DepthB, SizeB, DistanceA), loc(Xr, Yr), Situation):-
	situation(Situation,[Action|_]),
	shrinking(pk(Body, DepthB, SizeB, DistanceA), loc(Xr, Yr), do(Action, Situation)),
	!.