...
extending(pk(Body, DepthA, SizeA, DistanceA), loc(Xr, Yr), do(Action, Situation)):-
	...
	extending(pk(Body, DepthA, SizeA, DistanceA), loc(Xr, Yr), do(PreviousAction, Situation)),
	!.
	
extending(pk(Body, DepthB, SizeB, DistanceB), loc(Xr, Yr), Situation):-
	situation(Situation,[Action|_]),
	extending(pk(Body, DepthB, SizeB, DistanceB), loc(Xr, Yr), do(Action, Situation)),
	!.