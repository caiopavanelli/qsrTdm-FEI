...
approaching(pk(BodyA,_,SizeA,_),pk(BodyB,_,SizeB,_),loc(Xr,Yr),do(Action,Situation)):-	
	...
	approaching(pk(BodyA,_,SizeA,DistA),pk(BodyB,_,SizeB,DistB),loc(Xr,Yr),do(PreviousAction,Situation)), 
	!.
	
approaching(pk(BodyA,_,SizeA,_),pk(BodyB,_,SizeB,_),loc(Xr,Yr),Situation):-
