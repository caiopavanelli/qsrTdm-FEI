...
receding(pk(BodyA,_,SizeA,DistA), pk(BodyB,_,SizeB,DistB), loc(Xr,Yr), do(Action,Situation)):-
...
receding(pk(BodyA, _, SizeA, _), pk(BodyB, _, SizeB ,_), loc(X,Y), do(Action,Situation)):-
	robot(Robot),
...
receding(pk(BodyA, _, SizeA, _), pk(BodyB, _, SizeB ,_), loc(Xr,Yr), do(Action,Situation)):-
...
receding(pk(BodyA,_,SizeA,_),pk(BodyB,_,SizeB,_),loc(Xr,Yr),do(Action,Situation)):-	
	...
	receding(pk(BodyA,_,SizeA,DistA),pk(BodyB,_,SizeB,DistB),loc(Xr,Yr),do(PreviousAction,Situation)), 
	!.
	
receding(pk(BodyA,_,SizeA,_),pk(BodyB,_,SizeB,_),loc(Xr,Yr),Situation):-
